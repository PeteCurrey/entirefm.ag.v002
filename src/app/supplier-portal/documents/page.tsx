          ...
          <div className="bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden p-6 space-y-4">
            ...
            <div className="divide-y divide-slate-100 text-xs font-mono">
              <div className="py-3 flex items-center justify-between">
                <div>
                  <div className="font-bold text-slate-900 font-sans">Public &amp; Products Liability Policy Schedule</div>
              ...
              <div className="py-3 flex items-center justify-between">
                <div>
                  <div className="font-bold text-slate-900 font-sans">F-Gas Company Registration (REFCOM Elite)</div>
