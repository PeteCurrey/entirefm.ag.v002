        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-sm p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              ...
              <span className="bg-emerald-100 text-emerald-800 text-[10.5px] font-light px-2.5 py-1 rounded font-bold">
                ACTIVE
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100 text-xs font-light">
              <div>
              ...
              <div className="space-y-4 text-xs">
                {rel.assigned_entirefm_team.map((c, i) => (
                  <div key={i} className="space-y-1 pb-3 border-b border-slate-100 last:border-0 last:pb-0">
                    ...
                    {c.department && <span className="text-[11px] text-slate-500 font-light block">{c.department}</span>}
