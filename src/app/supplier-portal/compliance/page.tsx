          ...
          <tbody className="divide-y divide-slate-200">
            {radar.map((item) => (
              <tr key={item.id} className="hover:bg-slate-50/50">
                ...
                <td className="p-3.5 font-mono text-[11px] text-slate-500">{item.category}</td>
                <td className="p-3.5 font-mono text-[11px] text-slate-900 font-bold">{item.expiry_date}</td>
                <td className="p-3.5 font-mono text-[11px] text-slate-700">{item.days_remaining} Days</td>
                <td className="p-3.5">
                  {item.status === 'VALID' && (
