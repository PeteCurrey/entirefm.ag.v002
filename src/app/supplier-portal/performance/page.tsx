      ...
      <main className="flex-1 py-12">
        <div className="container-custom max-w-4xl space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200">
            ...
            <span className="inline-block text-xs font-mono font-bold px-3 py-1 bg-emerald-100 text-emerald-900 rounded-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white border border-slate-200 p-5 rounded-sm shadow-sm space-y-1">
              ...
              <div className="text-2xl font-mono font-bold text-emerald-600">94.8%</div>
            ...
            <div className="bg-white border border-slate-200 p-5 rounded-sm shadow-sm space-y-1">
              ...
              <div className="text-2xl font-mono font-bold text-slate-900">88.5%</div>
            ...
            <div className="bg-white border border-slate-200 p-5 rounded-sm shadow-sm space-y-1">
              ...
              <div className="text-2xl font-mono font-bold text-slate-900">96.0%</div>
