...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/sheffield/hvac", {
  title: TRADE_LOCATION_PAIRINGS["sheffield/hvac"].metaTitle,
  description: TRADE_LOCATION_PAIRINGS["sheffield/hvac"].metaDescription,
});

export default function TradeLocationPage() {
  const item = TRADE_LOCATION_PAIRINGS["sheffield/hvac"];
