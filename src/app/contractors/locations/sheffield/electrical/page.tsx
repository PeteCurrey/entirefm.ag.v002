...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/sheffield/electrical", {
  title: TRADE_LOCATION_PAIRINGS["sheffield/electrical"].metaTitle,
  description: TRADE_LOCATION_PAIRINGS["sheffield/electrical"].metaDescription,
});

export default function TradeLocationPage() {
  const item = TRADE_LOCATION_PAIRINGS["sheffield/electrical"];
