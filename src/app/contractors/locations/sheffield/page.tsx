...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/sheffield", {
  title: "Contractors in Sheffield | Commercial FM Contractor Network | EntireFM",
  description:
    "Join the EntireFM Contractor Network in Sheffield. Manage compliance, commercial RAMS, work orders, and local facilities management opportunities.",
});

export default function CityContractorPage() {
  const loc = CONTRACTOR_LOCATIONS["sheffield"];
