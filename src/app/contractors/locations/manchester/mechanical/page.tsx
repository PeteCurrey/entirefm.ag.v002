...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/manchester/mechanical", {
  title: TRADE_LOCATION_PAIRINGS["manchester/mechanical"].metaTitle,
  description: TRADE_LOCATION_PAIRINGS["manchester/mechanical"].metaDescription,
});

export default function TradeLocationPage() {
  const item = TRADE_LOCATION_PAIRINGS["manchester/mechanical"];
