...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/manchester", {
  title: "Contractors in Manchester | Commercial FM Contractor Network | EntireFM",
  description:
    "Join the EntireFM Contractor Network in Manchester. Manage compliance, commercial RAMS, work orders, and local facilities management opportunities.",
});

export default function CityContractorPage() {
  const loc = CONTRACTOR_LOCATIONS["manchester"];
