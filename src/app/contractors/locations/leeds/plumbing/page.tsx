...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/leeds/plumbing", {
  title: TRADE_LOCATION_PAIRINGS["leeds/plumbing"].metaTitle,
  description: TRADE_LOCATION_PAIRINGS["leeds/plumbing"].metaDescription,
});

export default function TradeLocationPage() {
  const item = TRADE_LOCATION_PAIRINGS["leeds/plumbing"];
