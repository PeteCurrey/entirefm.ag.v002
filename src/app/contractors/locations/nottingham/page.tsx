...
export const metadata: Metadata = generateRouteMetadata("/contractors/locations/nottingham", {
  title: "Contractors in Nottingham | Commercial FM Contractor Network | EntireFM",
  description:
    "Join the EntireFM Contractor Network in Nottingham. Manage compliance, commercial RAMS, work orders, and local facilities management opportunities.",
});

export default function CityContractorPage() {
  const loc = CONTRACTOR_LOCATIONS["nottingham"];
