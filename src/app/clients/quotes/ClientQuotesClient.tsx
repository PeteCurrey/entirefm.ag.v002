    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#E8E8E5] pb-4">
        <div>
          ...
          <h1 className="text-2xl font-light text-[#111111] mt-1">Quotes &amp; Approvals</h1>
        ...
        <div className="text-xs font-normal text-[#6D6D68] bg-white px-3 py-1.5 rounded-lg border border-[#E8E8E5]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Quotes Table (2 cols) */}
        <div className="lg:col-span-2 rounded-xl border border-[#E8E8E5] bg-white shadow-sm overflow-hidden">
          <table className="w-full text-left text-[13px]">
            ...
            <tbody className="divide-y divide-[#E8E8E5] text-[#111111]">
              {quotes.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center text-[#9A9A95] text-xs">
                  ...
                  return (
                    <tr
                      ...
                      className={`cursor-pointer transition-colors ${
                        isSelected ? 'bg-brand-electric/10' : 'hover:bg-[#FAFAF8]'
                      }`}
                    >
                      ...
                      <td className="px-5 py-3.5 font-normal text-white">
                        <div>{q.title}</div>
                        {q.site_name && (
                          <span className="text-[11px] text-[#9A9A95] font-normal">{q.site_name}</span>
                        )}
                      </td>
                        ...
                        <span
                          className={`rounded px-2 py-0.5 font-normal text-[10px] border ${
                            q.status === 'APPROVED'
                              ...
                              : 'bg-[#F5F5F3] border-[#E8E8E5] text-[#6D6D68]'
                          }`}
                        >
                          {q.status}
                        </span>
        ...
        <div className="rounded-xl border border-[#E8E8E5] bg-white shadow-sm p-5 flex flex-col justify-between">
          {!selectedQuote ? (
            <div className="py-16 text-center text-xs text-[#9A9A95] space-y-2">
            ...
            <div className="space-y-4">
              <div className="border-b border-[#E8E8E5] pb-3">
                ...
                <h3 className="text-base font-medium text-[#111111] mt-0.5">{selectedQuote.title}</h3>
                <p className="text-xs font-normal text-brand-electric-bright mt-0.5">{selectedQuote.quote_number}</p>
              </div>

              {/* Price Breakdown */}
              <div className="rounded-lg bg-[#FAFAF8] border border-[#E8E8E5] p-3 space-y-2">
                <div className="flex justify-between text-xs text-[#6D6D68]">
                  <span>Net Price:</span>
                ...
                <div className="flex justify-between text-sm font-semibold border-t border-[#E8E8E5] pt-2 text-[#111111]">
              ...
              {['DRAFT', 'ISSUED', 'PENDING_APPROVAL'].includes(selectedQuote.status) && !actionSuccess && (
                <div className="space-y-3 pt-2">
                  <label className="block text-[11px] font-normal text-[#6D6D68] uppercase">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full rounded-lg border border-[#E8E8E5] bg-[#FAFAF8] p-2 text-xs text-white placeholder:text-[#9A9A95] focus:outline-none focus:border-brand-electric resize-none"
                  />
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="w-full py-2 rounded-lg border border-[#E8E8E5] bg-[#FAFAF8] hover:bg-white text-[#111111] text-xs font-medium flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50"
                  >
