/**
 * PUBLIC MULTIMODAL AI JOB LOGGING — /log-a-job
 * ===============================================
 * Public-facing entry point for AI-assisted job logging and fault triage.
 * Accessible to any client, facility manager, building owner or tenant without authentication.
...
export const metadata: Metadata = {
  title: 'Log a Job | Multimodal AI Helpdesk — EntireFM',
  description:
    'Submit reactive maintenance requests with AI-assisted multimodal image, video, and document analysis. Accessible to facilities managers, commercial tenants, and building owners nationwide.',
};
...
export default async function PublicLogAJobPage() {
  ...
  if (isClient && session) {
    ...
    // Public user context: provide representative active equipment taxonomy for AI matching demo
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-void text-brand-mist">
      <Header />
      <main className="flex-grow pt-28 sm:pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <AiLogAJobClient
          clientName={session?.orgName || 'Commercial Requester'}
