      ...
      <AdminPageHeader
        ...
        action={
          <div className="flex items-center gap-3">
            <span className="rounded bg-emerald-500/10 px-2.5 py-1 font-normal text-[11px] text-emerald-400 border border-emerald-500/20">
              ...
              >
                ...
                <div className="flex items-center justify-between pt-2 border-t border-brand-edge-dark/50">
                  ...
                  <Link
                    ...
                    className="rounded bg-brand-electric px-3 py-1 text-[11.5px] font-normal text-white hover:bg-brand-indigo shadow-sm"
                  >
                    Build Quote Draft →
                  </Link>
                </div>
