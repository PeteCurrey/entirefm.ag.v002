  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-sm shadow-sm p-6 space-y-4 text-xs font-mono">
        <h3 className="text-sm font-normal uppercase tracking-wider text-slate-900 pb-3 border-b border-slate-200 font-sans">
        ...
        <div className="space-y-2">
          <div className="flex justify-between py-2 border-b border-slate-100">
            ...
            <span className="font-light text-slate-900">90.0%</span>
          </div>
          <div className="flex justify-between py-2 border-b border-slate-100">
            <span>First-Time Fix (FTF) Target</span>
            <span className="font-light text-slate-900">80.0%</span>
          </div>
          <div className="flex justify-between py-2 border-b border-slate-100">
            <span>Minimum Sample Size for Reportability</span>
            <span className="font-light text-slate-900">5 Completed Jobs</span>
          </div>
          <div className="flex justify-between py-2 border-b border-slate-100">
