              ...
              {actions.length === 0 ? (
                ...
                actions.map((a) => (
                  <tr key={a.id} className="hover:bg-slate-50/50">
                    ...
                    <td className="py-3 px-4 font-bold text-slate-900 font-sans">{a.issue_summary}</td>
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className="inline-block text-[10px] px-2 py-0.5 rounded font-bold bg-slate-100 text-slate-800">
                        {a.status}
                      </span>
                    </td>
                  </tr>
