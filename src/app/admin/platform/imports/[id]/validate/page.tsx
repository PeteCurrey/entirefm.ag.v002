...
export default function ValidatingImportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-[22px] font-semibold text-[#101010]">Validating Import</h1>
        <p className="text-[13.5px] text-[#686866] mt-0.5">{data?.batch?.batch_reference}</p>
      </div>

      <ImportStepper currentStep="VALIDATE" batchId={id} />
