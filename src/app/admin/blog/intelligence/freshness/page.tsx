  ...
  return (
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Content Freshness &amp; Lifecycle Radar</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-800">
              <th className="text-left text-xs text-zinc-500 px-4 py-3 font-medium">Page Title / URL</th>
              <th className="text-left text-xs text-zinc-500 px-4 py-3 font-medium">Status</th>
              <th className="text-left text-xs text-zinc-500 px-4 py-3 font-medium">Last Updated</th>
              <th className="text-left text-xs text-zinc-500 px-4 py-3 font-medium">Freshness Signals</th>
              <th className="text-left text-xs text-zinc-500 px-4 py-3 font-medium">Action</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-zinc-800">
            {items.map((item, i) => (
              <tr key={i} className="hover:bg-zinc-800/30">
                ...
                <td className="px-4 py-3">
                  <span className={`text-xs px-2 py-0.5 rounded-full font-mono ${statusBadge(item.freshnessStatus)}`}>
