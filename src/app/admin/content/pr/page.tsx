    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          ...
          <div className="mt-1 text-xl font-light text-emerald-400 font-mono">{metrics.activeCampaignsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">MEDIA TARGETS</div>
          <div className="mt-1 text-xl font-light text-white font-mono">{metrics.mediaTargetsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">COMMENTARY QUEUE</div>
          <div className="mt-1 text-xl font-light text-amber-400 font-mono">{metrics.pendingCommentariesCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">EARNED COVERAGE</div>
          <div className="mt-1 text-xl font-light text-blue-400 font-mono">{metrics.earnedCoverageCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">BACKLINKS EARNED</div>
          <div className="mt-1 text-xl font-light text-emerald-400 font-mono">{metrics.backlinksCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">UNLINKED MENTIONS</div>
          <div className="mt-1 text-xl font-light text-purple-400 font-mono">{metrics.unlinkedMentionsCount}</div>
        </div>
      </div>
