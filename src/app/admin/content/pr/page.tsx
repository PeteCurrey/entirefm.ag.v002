    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-white mt-1">Digital PR &amp; Media Promotion</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="text-xs bg-emerald-600 hover:bg-emerald-500 text-white font-semibold px-3.5 py-2 rounded-lg flex items-center gap-1.5 shadow-sm transition-colors"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">ACTIVE CAMPAIGNS</div>
          <div className="mt-1 text-xl font-bold text-emerald-400 font-mono">{metrics.activeCampaignsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">MEDIA TARGETS</div>
          <div className="mt-1 text-xl font-bold text-white font-mono">{metrics.mediaTargetsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">COMMENTARY QUEUE</div>
          <div className="mt-1 text-xl font-bold text-amber-400 font-mono">{metrics.pendingCommentariesCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">EARNED COVERAGE</div>
          <div className="mt-1 text-xl font-bold text-blue-400 font-mono">{metrics.earnedCoverageCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">BACKLINKS EARNED</div>
          <div className="mt-1 text-xl font-bold text-emerald-400 font-mono">{metrics.backlinksCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">UNLINKED MENTIONS</div>
          <div className="mt-1 text-xl font-bold text-purple-400 font-mono">{metrics.unlinkedMentionsCount}</div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-zinc-800 flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-500 font-mono">Human-Reviewed Pitching Only</span>
        </div>
            ...
            <div key={camp.id} className="p-5 hover:bg-zinc-800/30 transition-colors flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div className="space-y-1.5 max-w-3xl">
                <div className="flex items-center gap-2.5">
                  ...
                  <Link href={camp.primary_asset_url} className="text-xs text-emerald-400 hover:underline font-mono">
