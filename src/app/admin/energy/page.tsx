    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">TOTAL METERS</div>
          <div className="mt-1 text-xl font-light text-white">{metrics.totalMetersCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">ACTIVE FEEDS</div>
          <div className="mt-1 text-xl font-light text-emerald-400">{metrics.activeMetersCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">STALE FEEDS</div>
          <div className="mt-1 text-xl font-light text-amber-400">{metrics.staleFeedsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">BASELOAD ALERTS</div>
          <div className="mt-1 text-xl font-light text-purple-400">{metrics.baseloadAlertsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">ACTIVE PROJECTS</div>
          <div className="mt-1 text-xl font-light text-blue-400">{metrics.activeProjectsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">VERIFIED SAVINGS</div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-zinc-800 flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-500 font-normal">Multi-Utility Ingestion</span>
        </div>
              ...
              {meters.map((m) => (
                <tr key={m.id} className="hover:bg-zinc-800/40">
                  <td className="py-3.5 px-4">
                    ...
                    <div className="text-[11px] text-zinc-500 font-normal">{m.meter_reference}</div>
                  </td>
                  <td className="py-3.5 px-4 font-normal text-zinc-300">{m.utility_type}</td>
                  <td className="py-3.5 px-4 font-normal text-zinc-400">{m.meter_hierarchy}</td>
                  <td className="py-3.5 px-4 font-normal text-zinc-400">{m.interval_minutes} mins</td>
                  <td className="py-3.5 px-4">
