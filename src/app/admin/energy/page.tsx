    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-white mt-1">Energy &amp; Building Performance</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          ...
          <div className="mt-1 text-xl font-bold text-white font-mono">{metrics.totalMetersCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">ACTIVE FEEDS</div>
          <div className="mt-1 text-xl font-bold text-emerald-400 font-mono">{metrics.activeMetersCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">STALE FEEDS</div>
          <div className="mt-1 text-xl font-bold text-amber-400 font-mono">{metrics.staleFeedsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">BASELOAD ALERTS</div>
          <div className="mt-1 text-xl font-bold text-purple-400 font-mono">{metrics.baseloadAlertsCount}</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">ACTIVE PROJECTS</div>
          <div className="mt-1 text-xl font-bold text-blue-400 font-mono">{metrics.activeProjectsCount}</div>
        </div>
