    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-white mt-1">SEO Priority Queue &amp; Health Architecture</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          ...
          <div className="mt-1 text-xl font-bold text-white font-mono">326 Routes</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">HISTORIC PROTECTED 200s</div>
          <div className="mt-1 text-xl font-bold text-emerald-400 font-mono">229 / 229 (100%)</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">CANONICAL CONSISTENCY</div>
          <div className="mt-1 text-xl font-bold text-blue-400 font-mono">100% www.entirefm.com</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-mono">BROKEN INTERNAL LINKS</div>
          <div className="mt-1 text-xl font-bold text-purple-400 font-mono">0 Clean</div>
        </div>
      </div>
