    ...
    <main className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">TRACKED OPPORTUNITIES</div>
          <div className="mt-1 text-xl font-light text-white">Top 20 Pages</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">COMBINED GSC DEMAND</div>
          <div className="mt-1 text-xl font-light text-emerald-400">250k+ Impressions</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">QUERY CANNIBALISATION</div>
          <div className="mt-1 text-xl font-light text-blue-400">0 Collisions</div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          <div className="text-zinc-500 text-[10px] uppercase font-medium">REMEDIATION STATUS</div>
          <div className="mt-1 text-xl font-light text-purple-400">100% Deployed</div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-zinc-800 flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-500 font-normal">GSC Verified Data</span>
        </div>
          ...
          <tbody className="divide-y divide-zinc-800">
            {opportunities.map((opp) => (
              <tr key={opp.url} className="hover:bg-zinc-800/40">
                <td className="py-3.5 px-4 font-light text-zinc-400">#{opp.priority}</td>
                <td className="py-3.5 px-4">
                  <div className="font-normal text-white">{opp.url}</div>
                  <div className="text-[10px] font-normal text-zinc-500">{opp.type}</div>
                </td>
                <td className="py-3.5 px-4 text-zinc-300 font-normal text-[11px]">{opp.query}</td>
