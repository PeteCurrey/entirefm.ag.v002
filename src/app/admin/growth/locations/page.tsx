          ...
          <tbody className="divide-y divide-zinc-800">
            {clusters.map((c) => (
              <tr key={c.key} className="hover:bg-zinc-800/40">
                ...
                <td className="py-3.5 px-4 font-mono text-pink-400 font-light">{c.leadsCount}</td>
                <td className="py-3.5 px-4 font-mono text-emerald-400 font-light">{c.qualifiedLeadsCount}</td>
