...
export default async function EngineerProfilePage() {
  ...
  return (
    <div className="px-4 py-6 pb-24 space-y-6">
      <h1 className="text-white text-xl font-bold">Engineer Profile</h1>
      ...
      <div className="bg-brand-carbon border border-brand-edge-dark rounded-2xl p-6 text-center space-y-3">
        ...
        <div>
          <h2 className="text-white text-lg font-bold">{session.name || 'Field Engineer'}</h2>
      ...
      <div className="bg-brand-carbon border border-brand-edge-dark rounded-xl p-4 space-y-3">
        <h3 className="text-white text-sm font-semibold">Field Application</h3>
        ...
        <div className="flex justify-between text-xs text-brand-mist py-1">
          ...
          <span className="text-brand-electric font-semibold">ASSIST Mode</span>
        </div>
      </div>

      <Link
        href="/api/auth/sign-out"
        className="flex items-center justify-center gap-2 w-full bg-brand-void border border-red-800/60 text-red-400 py-3.5 rounded-xl font-semibold hover:bg-red-950/30 transition-colors"
      >
