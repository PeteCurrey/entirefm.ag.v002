    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Document Vault', href: '/resources/document-vault', detail: 'Verified checklists, templates and registers' },
          { label: 'The Building Walk', href: '/building-walk', detail: 'Site survey walkthroughs & plantroom insights' },
