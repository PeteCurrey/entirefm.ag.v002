...
export const PRIMARY_NAV: NavSection[] = [
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'AI + CAFM Software', href: '/resources/ai-in-facilities-management/ai-cafm', detail: 'Modern facilities software architecture' },
  ...
  },
  {
    ...
    feature: {
      ...
      body: 'Sign in to the Supplier Portal for job tickets, document tracking, compliance submissions, and invoicing.',
      href: '/supplier-portal/sign-in',
      cta: 'Sign in to Portal',
      secondaryHref: '/suppliers',
      secondaryCta: 'View Supplier Hub →',
      imageKey: 'client-review',
    },
  },
];
...
export const FOOTER_NAV: NavColumn[] = [
  {
    ...
    links: [
      ...
      { label: 'Commercial Cleaning', href: '/cleaning-services' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Contact', href: '/contact-us' },
      { label: 'Log a Job', href: '/log-a-job' },
    ],
  },
  {
