...
export const SUPPLIER_FAQS: SupplierFaqItem[] = [
  ...
  // 3. PARTNER NETWORK & ASSURANCE STANDARDS
  {
    id: 'faq-16',
    category: 'commercial',
    question: 'What is required to submit a supplier application?',
    answer: 'Submitting an application requires creating a verified supplier profile, specifying your trade disciplines and operating regions, and uploading your company registration, insurance schedules, health and safety policies, and trade qualifications.',
  },
  {
    id: 'faq-17',
    category: 'commercial',
    question: 'What is the EntireFM Partner Network?',
    answer: 'The EntireFM Partner Network is our framework for managing verified supplier relationships, technical qualifications, digital document compliance, and communication across our regional operating hubs.',
  },
  {
    id: 'faq-18',
    category: 'commercial',
    question: 'How does EntireFM maintain supply chain quality?',
    answer: 'EntireFM maintains a secure, auditable, and continuously monitored supply chain through dedicated technical review desks, digital compliance vaults, and automated insurance and accreditation renewal tracking.',
  },
  {
    id: 'faq-19',
    category: 'commercial',
    question: 'What is the Supplier Assurance Review process?',
    answer: 'The Supplier Assurance Review is an independent technical due diligence process evaluating your company credentials, health and safety policies, insurance schedules, and verified trade accreditations against client and statutory standards.',
  },
  {
    id: 'faq-20',
    category: 'commercial',
    question: 'What happens during technical vetting?',
    answer: 'Dedicated compliance officers audit your company documents, verify statutory accreditations (such as Gas Safe, NICEIC, REFCOM, SafeContractor), validate insurance policies with underwriters, and review RAMS templates.',
  },
  {
    id: 'faq-21',
    category: 'commercial',
    question: 'What criteria determine supplier approval?',
    answer: 'Supplier approval is strictly based on technical competence, verified accreditation, valid insurance, safe working practices, and compliance audit outcomes. There are no shortcuts or commercial bypasses to approval.',
  },
  {
    id: 'faq-22',
    category: 'commercial',
    question: 'How is work allocated to approved suppliers?',
    answer: 'Work opportunities are awarded based on technical capability, operational SLA performance, geographical proximity, client requirements, and competitive commercial pricing. Registration does NOT guarantee work allocation.',
  },
  {
    id: 'faq-23',
    category: 'commercial',
    question: 'Does EntireFM operate a procurement firewall?',
    answer: 'Yes. EntireFM operates a non-negotiable procurement firewall. Work allocation algorithms evaluate only verified operational metrics, engineer location, and technical competence.',
  },
  {
    id: 'faq-24',
    category: 'commercial',
    question: 'How does a supplier become a Preferred Supplier?',
    answer: 'Preferred Supplier status cannot be purchased or fast-tracked. It is earned through sustained high operational performance, first-time fix excellence, SLA adherence, and reliable service reporting.',
  },
  {
    id: 'faq-25',
    category: 'commercial',
    question: 'What is a Strategic Partner?',
    answer: 'Strategic Partner status is an invitation-only executive relationship based on significant national scale, deep technical integration, or critical OEM support.',
  },
  {
    id: 'faq-26',
    category: 'commercial',
    question: 'What is the difference between registration and approval?',
    answer: 'Registration is the initial application and submission of company credentials. Approval is the formal outcome of technical due diligence, authorising your organisation to perform operational works on EntireFM managed properties.',
  },

  // 4. CONTRACTOR REMITTANCES & COMMERCIAL TERMS
  {
    id: 'faq-27',
    category: 'commercial',
    question: 'How are suppliers paid for completed operational work?',
    answer: 'Work completed for EntireFM is managed through the applicable work order, purchase order, approval and invoicing process. Remittances are paid directly by BACS under agreed commercial payment terms.',
  },
  {
    id: 'faq-28',
    category: 'commercial',
    question: 'What are EntireFM\'s payment terms for contractor invoices?',
    answer: 'Approved contractor invoices matched against valid purchase orders and completed service reports are settled by BACS according to standard commercial payment terms agreed in your supplier schedule.',
  },
  {
    id: 'faq-30',
    category: 'commercial',
    question: 'Where can I track work order remittances and submitted documents?',
    answer: 'All work order remittances, document compliance statuses, and active trade scopes are transparently visible in your Supplier Portal.',
  },
