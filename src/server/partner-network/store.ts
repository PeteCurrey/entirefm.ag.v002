  ...
  private seedDefaultCommercialProducts() {
    const products: CommercialProduct[] = [
      ...
      },
      {
        ...
        public_name: 'Contractor Network Membership',
        internal_name: 'Contractor Network Member (£295/yr)',
        ...
        benefits: ['Full CAFM document vault', 'Automated ticket expiry tracking', 'Verified Network Partner Badge', 'Event priority booking', 'Complete Contractor Platform access upon approval'],
        effective_date: '2026-08-28',
      },
      {
        id: 'prod-mem-t2',
        internal_id: 'MEM-CONTRACTOR-T2',
        public_name: 'Contractor Network Partner Membership',
        internal_name: 'Contractor Network Partner (£695/yr)',
        ...
        benefits: ['Multi-User Portal Seats', 'Expanded multi-region profile', 'Technical Forum & Event Priority', 'Supplier Spotlight Feature', 'Complete Contractor Platform access upon approval'],
        effective_date: '2026-08-28',
      },
      {
