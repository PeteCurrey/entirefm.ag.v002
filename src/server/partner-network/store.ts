...
class MemoryPartnerCommercialStore {
  ...
  private seedDefaultCommercialProducts() {
    const products: CommercialProduct[] = [
      ...
      {
        id: 'prod-mem-v3',
        internal_id: 'MEM-SUPPLIER-ANNUAL-V3',
        public_name: 'EntireFM Supplier Membership',
        internal_name: 'EntireFM Supplier Membership (£95/yr)',
        description: 'Complete access to the EntireFM supplier platform, compliance infrastructure, operational tools, business tools, and Partner Network.',
        category: 'SUPPLIER_MEMBERSHIP',
        price_gbp: 95,
        vat_rate: 0.20,
        billing_frequency: 'ANNUAL',
      ...
      {
        id: 'prod-mem-t1',
        internal_id: 'MEM-CONTRACTOR-T1',
        public_name: 'Contractor Network Membership (Legacy)',
        internal_name: 'Contractor Network Member (£295/yr) [Legacy]',
        description: 'Legacy membership product. Retained for historical transaction audit.',
        category: 'SUPPLIER_MEMBERSHIP',
        price_gbp: 295,
        vat_rate: 0.20,
        billing_frequency: 'ANNUAL',
        ...
        invoice_eligible: false,
        eligible_supplier_types: ['LOCAL_SME', 'REGIONAL_CONTRACTOR', 'SPECIALIST_CONTRACTOR', 'NATIONAL_CONTRACTOR'],
        benefits: ['Full CAFM document vault', 'Automated ticket expiry tracking', 'Verified Network Partner Badge'],
        effective_date: '2026-08-28',
      },
      {
        id: 'prod-mem-t2',
        internal_id: 'MEM-CONTRACTOR-T2',
        public_name: 'Contractor Network Partner Membership (Legacy)',
        internal_name: 'Contractor Network Partner (£695/yr) [Legacy]',
        description: 'Legacy partner product. Retained for historical transaction audit.',
        category: 'SUPPLIER_MEMBERSHIP',
        price_gbp: 695,
        vat_rate: 0.20,
        billing_frequency: 'ANNUAL',
        ...
        benefits: ['Multi-User Portal Seats', 'Expanded multi-region profile'],
        effective_date: '2026-08-28',
      },
      {
