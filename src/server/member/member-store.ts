...
function seedInitialMembers() {
  ...
  const seed1: Member = {
    ...
    first_name: 'Pete',
    last_name: 'Currey',
    email: 'pete.currey@entirefm.com',
    username: 'pete-currey',
    avatar_url: undefined,
    headline: 'Managing Director & Building Services Lead | EntireFM',
    bio: 'Leading facilities management, statutory compliance governance, and mechanical engineering delivery across UK commercial property portfolios.',
    company: 'EntireFM',
    ...
    qualifications: ['IWFM Member', 'Hard FM Specialist'],
