...
const RELATIONSHIPS: EntityRelationship[] = [
  // Building Safety relationships
  {
    ...
    targetType: 'tool',
    targetId: 'asset-scanner',
    targetTitle: 'Plant & Asset Scanner',
    targetUrl: '/tools/asset-scanner',
  ...
  },
  {
    ...
    targetTitle: 'Statutory Compliance Framework',
    targetUrl: '/lobby/check',
    targetSnippet: 'Master reference matrix of all UK statutory maintenance obligations.',
    targetBadge: 'Framework',
    weight: 9,
  },
  {
    id: 'rel-bsa-03',
  ...
  // Condenser airflow / HVAC relationships
  {
    ...
    relationshipType: 'PUT_INTO_PRACTICE_WITH',
    targetType: 'tool',
    targetId: 'ppm-schedule-builder',
    targetTitle: 'PPM Schedule Builder',
    targetUrl: '/tools/ppm-schedule-builder',
...
const EDITORIAL_CANDIDATES: EditorialCandidate[] = [
  {
    ...
    status: 'candidate',
    authorMemberName: 'Peter Currey & Liam O’Connor',
