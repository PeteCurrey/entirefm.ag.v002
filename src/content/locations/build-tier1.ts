...
function buildShortForm(city: Tier1City, registryPaths: Set<string>): ContentRecord {
  ...
  // Dedicated search intent differentiation for London: Outsourced / Integrated FM
  if (city.slug === 'london') {
    return {
      path,
      ...
      sections: [
        {
          ...
          bullets: [
            ...
            'Unified helpdesk and central 24/7 escalation for all maintenance lines',
            'Consolidated monthly billing with transparent job costing per property',
          ],
        },
        {
        ...
        },
        {
          ...
          body: 'A successful outsourced FM partnership begins with meticulous contract mobilisation. Our proven 8-step transition framework eliminates service disruption when taking over from incumbent providers:',
          bullets: [
            'Comprehensive plant and physical asset verification surveys across all London sites',
            'Statutory compliance audit and obligation mapping against current UK regulations',
            'Digital asset barcoding and registration within EntireCAFM',
            'Detailed SFG20 PPM schedule creation aligned with actual equipment lifecycle',
            'Contractual SLA and KPI agreement based on priority tiers and building criticality',
            'Structured incumbent supplier handover and TUPE / subcontractor transition management',
            '24/7 reactive escalation workflow and emergency dispatch configuration',
            'Client portal training, digital logbook configuration, and executive governance kickoff',
          ],
        },
        {
          ...
          bullets: [
            'Live client dashboard for real-time work order and attendance tracking',
            '100% digital statutory certificate vault (EICR, CP12, L8, fire alarm, LOLER)',
            'Automated SLA monitoring and contractual KPI performance scorecards',
            'Complete asset lifecycle records and planned expenditure forecasting',
          ],
        },
        {
      ...
      breadcrumbs: [
        { name: 'Home', url: '/' },
        { name: 'Locations', url: '/locations' },
        { name: 'Outsourced FM London', url: '/fm-london' },
      ],
