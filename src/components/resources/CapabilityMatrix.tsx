...
const MATRIX_DATA: UseCaseCategory[] = [
  ...
  },
  {
    ...
    operationalImpact: 'Validates compliance audit readiness and eliminates the risk of missed annual statutory inspection deadlines.',
  ...
  },
  {
    ...
    technicalCapabilities: [
      ...
      'Zero-retention data privacy protocols protecting tenant occupancy and commercial data',
    ],
    operationalImpact: 'Protects building infrastructure from cyber vulnerabilities and maintains compliance with UK GDPR and Building Safety Act standards.',
