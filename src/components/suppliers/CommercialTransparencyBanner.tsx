...
export function CommercialTransparencyBanner() {
  return (
    <div className="bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-200 p-6 sm:p-8 gap-6 text-xs font-mono">
        {/* What Fees Support */}
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-slate-600 font-sans">
            <li className="flex items-start gap-2">
              <span className="text-emerald-600 font-bold font-mono">&check;</span>
        ...
        <div className="space-y-3 pt-6 md:pt-0">
          ...
          <ul className="space-y-2 text-slate-600 font-sans">
            <li className="flex items-start gap-2">
              <span className="text-rose-600 font-bold font-mono">&times;</span>
