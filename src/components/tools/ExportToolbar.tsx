      ...
      <div className="flex flex-wrap items-center gap-2.5">
        {onDownloadPdf && (
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-brand-graphite hover:bg-slate-800 text-white font-semibold text-xs rounded-sm shadow-sm transition-all duration-200 hover:shadow"
        ...
        {onDownloadCsv && (
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 hover:text-slate-900 font-medium text-xs rounded-sm border border-slate-200 transition-colors"
