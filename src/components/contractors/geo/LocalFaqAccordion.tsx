...
export function LocalFaqAccordion({ locationName, faqs }: LocalFaqAccordionProps) {
  const jsonLd = {
  ...
  return (
    <section className="py-20 bg-[#FAF9FB] border-b border-slate-200" aria-label="Regional Frequently Asked Questions">
      <script
      ...
      <div className="container-custom max-w-4xl space-y-10">
        <div className="space-y-3">
          ...
          <h2 className="text-2xl sm:text-3xl font-extralight text-slate-900 tracking-tight">
            Frequently Asked Questions: {locationName} Contractors
          </h2>
          <p className="text-xs sm:text-sm text-slate-600 font-light leading-relaxed">
            Guidance on operating with EntireFM in {locationName}, onboarding requirements, and commercial dispatch.
          </p>
        </div>
