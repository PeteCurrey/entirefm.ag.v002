    ...
    <section className="py-24 bg-[#FAF9FB] border-b border-slate-200">
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="rounded-sm border border-slate-200 bg-white p-8 lg:p-10 flex flex-col justify-between shadow-sm relative overflow-hidden">
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                ...
                <span className="px-2.5 py-1 rounded bg-slate-100 text-slate-600 text-[11px] font-light">
          ...
          <div className="rounded-sm border-2 border-slate-900 bg-slate-900 text-white p-8 lg:p-10 flex flex-col justify-between shadow-xl relative overflow-hidden">
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-slate-800">
                ...
                <span className="px-2.5 py-1 rounded bg-brand-pink/20 text-brand-pink border border-brand-pink/30 text-[11px] font-light">
                  Live Platform
                </span>
              </div>
