...
const REALITY_FORMATS = [
  { format: '3D Gaussian Splat (.splat / .ksplat)', desc: 'Radiance field rendering preserving photorealistic lighting and complex geometry for real-time web walkthroughs.' },
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-base sm:text-lg text-slate-300 font-light leading-relaxed max-w-2xl">
              EntireFM’s Gaussian Splat capture transforms thousands of aerial images into an immersive spatial radiance model, allowing teams to inspect context, understand assets, and revisit captured conditions long after the drone has landed.
            </p>
          </div>
