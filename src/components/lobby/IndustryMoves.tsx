        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-neutral-200">
              <div>
                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-electric font-semibold block mb-0.5">
                  MARKET ACTIVITY
                </span>
              ...
              {contracts.map((item) => (
                <article key={item.id} className="pt-4 first:pt-0 space-y-2 group">
                  <div className="flex items-center gap-2">
                    {item.contractValue && (
                      <span className="text-[11px] font-mono font-medium px-2 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-sm">
                        {item.contractValue}
                      </span>
                    )}
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-neutral-200">
              <div>
                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400 font-semibold block mb-0.5">
                  LEADERSHIP MOVES
                </span>
                <h3 className="text-xl sm:text-2xl font-extralight text-neutral-900">
                  People &amp; Appointments
