  ...
  return (
    <header className="relative h-full w-full bg-brand-void text-white overflow-hidden flex flex-col justify-between font-sans">
      ...
      <div className="container-wide relative z-10 flex flex-col justify-between h-full pt-6 sm:pt-8 lg:pt-10 pb-6 sm:pb-8">
        ...
        {/* ── CENTER / LOWER HERO: THE LOBBY TITLE & CENTRED WHITE COMPOSER ── */}
        <div className="w-full max-w-4xl mx-auto my-auto py-4 sm:py-6 flex flex-col items-center text-center space-y-6 sm:space-y-8">
          ...
          {/* ── Centred White Ask The Lobby Composer (Gently Rounded 8px) ── */}
          <div className="w-full max-w-3xl mx-auto space-y-4 text-left">
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-3 mt-2 border-t border-neutral-100">
                {/* Mode Selector (Subtle, Not Chunky SaaS Tabs) */}
