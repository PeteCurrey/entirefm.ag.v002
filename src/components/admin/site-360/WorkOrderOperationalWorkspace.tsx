  ...
  if (!workOrder) {
    return (
      <div className="rounded-[16px] border border-[#E4E4E1] bg-[#FFFFFF] p-12 text-center shadow-[0_1px_3px_rgba(0,0,0,0.02)] space-y-3">
        ...
        <h3 className="text-[16px] font-medium text-[#101010]">No Work Order Selected</h3>
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 rounded-[8px] bg-[#FF6B24] px-4 py-2 text-[12.5px] font-medium text-white shadow-sm hover:bg-[#E9540F] transition-all"
        >
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 font-mono text-[12px]">
          <div className="rounded-[10px] border border-[#E4E4E1] bg-[#F9F9F8] p-3">
            ...
            <div className="text-[13px] font-semibold text-[#101010] mt-1 flex items-center gap-1">
