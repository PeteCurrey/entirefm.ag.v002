...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[8px] border border-[#E8E8E5] bg-[#FFFFFF] p-7 text-center">
      ...
      <h3 className="mt-3 text-[14px] font-light text-[#111111]">{title}</h3>
      ...
      {resolvedText && (
        resolvedHref ? (
          <Link
            href={resolvedHref}
            className="mt-4 inline-flex items-center gap-1.5 rounded-[6px] bg-[#EA580C] px-3.5 py-1.5 text-[12px] font-normal text-white hover:bg-[#C2410C] transition-all"
          >
