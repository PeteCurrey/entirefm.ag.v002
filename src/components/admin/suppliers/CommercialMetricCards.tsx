  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <span className="text-[10px] text-slate-400 font-normal">{metrics.activePayingSuppliers} Paying Members</span>
      </div>
      ...
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <span className="text-[10px] text-slate-400 font-normal">{metrics.outstandingInvoicesCount} Pending BACS/Stripe</span>
      </div>
      ...
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <div className="flex items-baseline justify-between">
          <span className={`text-xl font-light${metrics.overdueInvoicesValueGbp > 0 ? 'text-rose-600' : 'text-slate-900'}`}>
            £{metrics.overdueInvoicesValueGbp.toLocaleString()}
          </span>
          <AlertTriangle className="h-4 w-4 text-rose-500" />
        </div>
        <span className="text-[10px] text-slate-400 font-normal">{metrics.overdueInvoicesCount} Overdue Invoices</span>
      </div>
      ...
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-xl font-light text-slate-900">{metrics.membershipsDueRenewalCount}</span>
          <Calendar className="h-4 w-4 text-amber-500" />
        </div>
        <span className="text-[10px] text-slate-400 font-normal">Upcoming Reminders</span>
      </div>
      ...
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <span className="text-[10px] text-slate-400 font-normal">Forum &amp; Breakfasts</span>
      </div>
      ...
      <div className="p-3.5 bg-white border border-slate-200 rounded-sm shadow-sm space-y-1">
        ...
        <span className="text-[10px] text-slate-400 font-normal">OEM &amp; Tech Packages</span>
      </div>
    </div>
  );
}
