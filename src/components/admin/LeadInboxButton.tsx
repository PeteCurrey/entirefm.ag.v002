...
export function LeadInboxButton({ initialCount = 0 }: LeadInboxButtonProps) {
  ...
  return (
    ...
    >
      ...
      {newLeadsCount > 0 && (
        <span className="absolute -top-1 -right-1 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-[#FF3E9D] px-1 font-mono text-[10px] font-bold text-white shadow-sm ring-2 ring-white">
