...
export const LOBBY_DATA: LobbyContent = {
  ...
  briefingStrip: [
    {
      ...
      summary:
        'Refrigerant reclamation allocations have reduced virgin R410A availability by a further 18%. PPM leak-testing schedules must be strictly maintained to prevent emergency recharge lockouts.',
    ...
    },
    {
      ...
      summary:
        'Annual thermographic surveys are increasingly required by major property insurers alongside standard 5-yearly EICR testing for high-density logistics and manufacturing switchrooms.',
    ...
    },
    {
      ...
      summary:
        'Sentinels on cold water storage tanks require bi-weekly validation where ambient plantroom temperatures exceed 20°C to prevent biological growth spikes.',
  ...
  lobbyPulse: {
    ...
    totalVotesBaseline: 428,
    options: [
      { id: 'p1', label: 'Compliance & Statutory Evidence Gaps', percentage: 34 },
      { id: 'p2', label: 'Supply Chain & Subcontractor Reliability', percentage: 26 },
      { id: 'p3', label: 'HVAC Plant Age & Energy Costs', percentage: 19 },
      { id: 'p4', label: 'Budget Pressure & Reactive Overspend', percentage: 13 },
      { id: 'p5', label: 'CAFM Data Hygiene & Asset Visibility', percentage: 8 },
    ],
  },
