...
export const LOBBY_DATA: LobbyContent = {
  ...
  briefingStrip: [
    ...
    },
    {
      ...
      timestamp: 'Yesterday',
      topicImage: '/images/editorial/entirefm-switchgear-inspection-1200w.webp',
      topicImageAlt: 'Commercial electrical switchgear and distribution cabinet inspection',
