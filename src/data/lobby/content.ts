  ...
  briefingStrip: [
    {
      ...
      topicImage: '/images/editorial/entirefm-hvac-refrigerant-check-1200w.webp',
      topicImageAlt: 'HVAC engineer performing refrigerant check on commercial air conditioning unit',
    ...
    },
    {
      ...
      timestamp: 'Yesterday',
      topicImage: '/images/editorial/entirefm-distribution-board-testing-1200w.webp',
      topicImageAlt: 'Electrical engineer inspecting commercial distribution board during EICR testing',
    ...
    },
    {
      ...
      topicImage: '/images/editorial/entirefm-plumbing-booster-set-1200w.webp',
      topicImageAlt: 'Commercial plumbing booster set in plant room with pressure gauges',
