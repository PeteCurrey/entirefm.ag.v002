      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="max-w-3xl space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <a href={`mailto:${CONTACT_CONFIG.careersEmail}`} className="btn-primary py-3 px-6 text-xs font-bold shadow-command">
        ...
        <section className="section-padding bg-white">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {roles.map((r, idx) => (
                <div key={idx} className="p-6 bg-brand-surface border border-brand-border rounded-sm space-y-4 hover:border-brand-gold transition-colors">
        ...
        <section className="section-padding bg-brand-surface border-t border-brand-border">
          <div className="container-custom max-w-4xl space-y-6">
            <h2 className="text-2xl font-bold text-brand-navy">Why Work With EntireFM?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="flex items-start gap-3 p-4 bg-white border border-brand-border rounded-sm">
                <CheckCircle2 className="w-5 h-5 text-brand-gold shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-sm font-bold text-brand-navy">Modern Fleet & Tooling</h4>
              ...
              <div className="flex items-start gap-3 p-4 bg-white border border-brand-border rounded-sm">
                <CheckCircle2 className="w-5 h-5 text-brand-gold shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-sm font-bold text-brand-navy">Continuous CPD & Training</h4>
