  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        {/* Legal Header */}
        <section className="bg-brand-graphite border-b border-brand-edge-dark text-white py-12 relative overflow-hidden">
        ...
        <section className="section-padding bg-white">
          <div className="container-custom max-w-4xl space-y-8">
            <div className="prose prose-slate max-w-none text-slate-700 space-y-6 text-sm sm:text-base leading-relaxed">
              <h2 className="text-xl font-bold text-brand-graphite">1. Policy Overview & Commitment</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-brand-graphite">2. Compliance & Statutory Governance</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-brand-graphite">3. Contact & Inquiries</h2>
              <p>
