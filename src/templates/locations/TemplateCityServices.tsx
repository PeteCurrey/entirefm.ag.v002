      ...
      <main className="pt-24 pb-20">
        <div className="container-custom">
          ...
          <section className="mb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                >
                  <span className="font-mono text-[10px] font-bold text-[#EA580C] block mb-1">
                    {cat.count}
                  </span>
            ...
            <div className="rounded-[16px] border border-[#E4E4E1] bg-white p-6 sm:p-8 lg:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.06)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    <div>
                      <h4 className="text-[14px] font-semibold text-[#101010] group-hover:text-[#EA580C] transition-colors">
                        {item.title}
                      </h4>
          ...
          <section id="compliance" className="mb-16 scroll-mt-24">
            <div className="rounded-[16px] border border-[#E4E4E1] bg-white p-6 sm:p-8 lg:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.06)]">
              <div className="max-w-2xl mb-8">
                <span className="inline-flex items-center gap-1.5 rounded-[5px] border border-[#A7F3D0] bg-[#ECFDF5] px-2.5 py-0.5 font-mono text-[10.5px] font-bold text-[#059669] mb-2">
                  STATUTORY TESTING
                </span>
                <h2 className="text-2xl sm:text-3xl font-semibold text-[#101010] tracking-tight">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    <span className="font-mono text-[10px] text-[#059669] font-bold block mb-1">
                      {comp.standard}
                    </span>
                    <h4 className="text-[13px] font-semibold text-[#101010] group-hover:text-[#059669] transition-colors">
                      {comp.name}
                    </h4>
                  </Link>
                ))}
