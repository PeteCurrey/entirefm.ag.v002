/**
 * Apply migration 0023 to remote Supabase via pg.
 */
...
const sql = readFileSync(
  '/Users/petercurrey/Desktop/Websites/EntireFM.AG.V002/supabase/migrations/0023_data_import_and_external_identity.sql',
  'utf8'
);
